...
class Metric(models.Model):
    ...
    code = models.CharField(max_length=50, unique=True, help_text="Internal code, e.g., B1610_WIND")
...
class Plant(models.Model):
    ...
    eic_code = models.CharField(max_length=50, unique=True, help_text="Unique EIC code for the plant/unit")
...
class TimeSeriesData(TimescaleModel):
    ...
    plant = models.ForeignKey(Plant, on_delete=models.CASCADE, null=True, blank=True, related_name='data_points')
